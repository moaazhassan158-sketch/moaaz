...
(function() {
    ...
    function extractCardData(card) {
        ...
        const name = nameEl ? nameEl.innerText.trim() : "شقة للإيجار";
        ...
        const url = window.location.href; // أو يمكن تحديثه لجلب رابط البطاقة
        ...
        return {
            ...
            "item": {
                ...
                "mainEntity": {
                    "@type": "Apartment",
                    "name": data.name,
                    "description": `شقة للإيجار في ${data.location}`,
                    "address": {
                        "@type": "PostalAddress",
                        "addressCountry": "SA",
